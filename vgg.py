...
def VGG(train_generator, val_generator, save_model_path = './model/'+'VGG.h5', log_dir = './logs/VGG'):
    ...
    model.summary()
    plot_model(model, to_file='./vgg/vgg16_bottleneck.png', show_shapes=True)
...
# VGG(train_generator, val_generator)
evaluate_model(test_generator, './model/VGG.h5')
