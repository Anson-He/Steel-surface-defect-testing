...
def xception(train_generator, val_generator, save_model_path = './model/'+'xception.h5', log_dir = './logs/xception'):
    ...
    model.summary()
    plot_model(model, to_file='./xception/xception_bottleneck.png', show_shapes=True)
...
# xception(train_generator, val_generator)
evaluate_model(test_generator, './model/xception.h5')
