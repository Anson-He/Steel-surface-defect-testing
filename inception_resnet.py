...
def inception_resnet(train_generator, val_generator, save_model_path = './model/'+'inception_resnet.h5', log_dir = './logs/inception_resnet'):
    ...
    model.summary()
    plot_model(model, to_file='./inception_resnet/inception_resnet_bottleneck.png', show_shapes=True)
...
# inception_resnet(train_generator, val_generator)
evaluate_model(test_generator, './model/inception_resnet.h5')
