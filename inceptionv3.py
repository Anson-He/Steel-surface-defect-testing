...
def Inception(train_generator, val_generator, save_model_path = './model/'+'InceptionV3.h5', log_dir = './logs/InceptionV3'):
    ...
    model.summary()
    plot_model(model, to_file='./inception/inceptionv3_bottleneck.png', show_shapes=True)
...
# Inception(train_generator, val_generator)
evaluate_model(test_generator, './model/InceptionV3.h5')
